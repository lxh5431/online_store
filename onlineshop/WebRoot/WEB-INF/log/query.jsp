	...
	<script type="text/javascript">
		$(function(){
			$('#dg').datagrid({   
			    ...
			    url:'log_queryby.action',
			    loadMsg:'Loading......',
			    queryParams:{username:''},//这里不需要传具体的name，因为我们要显示所有的
			    //width:300,
						...
						if(rows.length == 0) {
							...
							$.messager.confirm('删除的确认对话框', '您确定要删除此项吗？', function(r){
								if (r){
								    ...
								    //2. 发送ajax请求
								    $.post("log_deleteByIds.action",{ids:ids},function(result){
								    	if(result == "true") {
			    ...
			    columns:[[
			        ...
			        {field:'actionTime',title:'时间长',width:100},
