		...
		<div class="header">
			<div class="header_container">
				...
				<div class="top_bar clear">
					<!--头部小导航-->
					<div class="welcom fl">欢迎光临SONG SHOP!</div>
					<ul class="top_links fr">
						<li><a href="#">首页</a></li>
						<li><a href="#">我的账户</a></li>
						<li><a href="#">购物车</a></li>
						<li><a href="index2.jsp">后台管理</a></li>
						<li><a href="send_user_save.action">注册</a></li>
			...
			<div id="dd" class="action_buttonbar" style="text-align:center;">
				<form method="post" action="${shop}/user_login.action">
					...
					<div>
						...
						<input type="button" value="注册" onclick="window.open('send_user_save.action','_self')" style="width:60px;height:30px" />
					</div>
			   </form>
